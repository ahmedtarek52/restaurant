      ...
      {showPopup && (
        <div>
          <div className="h-screen w-screen fixed top-0 left-0 bg-black/50 z-50 backdrop-blur-sm">
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-4 shadow-md rounded-md w-[300px] duration-200">
                 ...
                 <div className="mt-4"><p className="text-center">or login with</p>
